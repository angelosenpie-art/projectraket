    ...
    >
        <div class="max-w-7xl mx-auto bg-white pb-2 pt-2 px-4 sm:px-6">
            ...
            <div class="hidden md:flex items-center justify-end md:flex-1 lg:w-0">
                ...
                <inertia-link v-if="$page.props.user" href="/dashboard" class="ml-8 font-bold whitespace-nowrap inline-flex items-center justify-center px-4 py-2 border border-transparent rounded-md shadow-sm text-lg text-white bg-black hover:bg-yellow-500">
                    Dashboard
                </inertia-link>

                <template v-else>
                    <inertia-link :href="route('login')"  class="text-green-700 py-2 px-4 rounded-md text-lg font-bold">
                        Login
                    </inertia-link>

                    <inertia-link v-if="canRegister" :href="route('register')" class="ml-8 font-bold whitespace-nowrap inline-flex items-center justify-center px-5 py-2 border border-transparent rounded-md shadow-sm text-lg text-white bg-green-600 hover:bg-green-700">
                        Register
                    </inertia-link>
                </template>
            </div>
        ...
        <main class="mt-10 mx-auto max-w-full px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
            <div class="lg:text-left">
                <h1 class="text-4xl tracking-tight font-extrabold text-gray-100 sm:text-5xl md:text-6xl">
                    ...
                    <span class="block text-green-200 xl:inline">Freelancer</span>
                </h1>
                <p class="mt-3 text-base text-gray-100 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
                    Find your local and international professional servies.
                    <br>It's more fun working with Filipino!
                </p>
                <div class="mt-5 pb-20 pt-20 sm:mt-8 sm:flex sm:justify-center lg:justify-start">
...
import Button from '../Jetstream/Button.vue'
    ...
    export default {
        ...
        data () {
            return {
                heading: "Find Your Filipino Freelancer"
            }
        },
    }
</script>